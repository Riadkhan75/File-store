...
export const FileCard: React.FC<FileCardProps> = ({
  ...
  return (
    <button
      ...
      className="group relative w-[95%] sm:w-[96%] h-[62px] sm:h-[66px] md:h-[68px] mx-auto bg-[#FFD000] hover:bg-[#FFE033] active:bg-[#FFC400] text-black font-extrabold uppercase rounded-[14px] border border-black/90 shadow-[0_4px_16px_rgba(255,208,0,0.35)] hover:shadow-[0_6px_24px_rgba(255,208,0,0.55)] hover:scale-[1.015] active:scale-[0.98] transition-all duration-200 ease-out flex items-center justify-center gap-2.5 sm:gap-3 px-4 select-none cursor-pointer outline-none shrink-0"
    >
